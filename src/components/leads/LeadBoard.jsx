        ...
        return (
            <div className="flex flex-col items-center justify-center p-10 h-full" style={{ fontFamily: '"Source Sans 3", Arial, sans-serif' }}>
                <div className="text-center mb-8">
                    ...
                    <p className="text-sm mb-6" style={{ color: "var(--muted-foreground)" }}>Configure your first pipeline to start managing leads.</p>
                    <Link
                        to="/pipeline"
                        ...
                        >
                            ...
                            <div className="flex-1 p-2.5 overflow-y-auto space-y-2.5 min-h-[80px]">
                                ...
                                {stageLeads.length === 0 && (
                                    ...
                                    >
                                        <p className="text-[9px] uppercase tracking-widest font-bold" style={{ color: "var(--muted-foreground)" }}>
                                            Empty Stage
                                        </p>
                                        <p className="text-[8px] mt-0.5 opacity-60" style={{ color: "var(--muted-foreground)" }}>
                                            Drop cards here
                                        </p>
                                    </div>
                                )}
                                {remaining > 0 && (
                                    <button
                                        ...
                                        style={{ border: "1px dashed var(--border)", color: "#5E6A43", backgroundColor: "var(--card)" }}
                                    >
