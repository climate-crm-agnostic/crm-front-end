                    ...
                    <CardContent>
                        <Accordion type="single" collapsible className="w-full">
                            ...
                            <AccordionItem value="item-fields-cat">
                                ...
                                <AccordionContent>
                                    <ul className="list-disc list-inside space-y-2 mt-2">
                                        <li><strong>Category Fields:</strong> <code className="px-1 rounded font-mono text-xs" style={{ backgroundColor: "var(--card)", color: "#4a5535" }}>name</code> (the category name), <code className="px-1 rounded font-mono text-xs" style={{ backgroundColor: "var(--card)", color: "#4a5535" }}>description</code> (details about the category's purpose), and <code className="px-1 rounded font-mono text-xs" style={{ backgroundColor: "var(--card)", color: "#4a5535" }}>parent</code> (links to a parent category to create subcategories).</li>
                                        <li><strong>Catalogue Item Fields:</strong> <code className="px-1 rounded font-mono text-xs" style={{ backgroundColor: "var(--card)", color: "#4a5535" }}>name</code> (product/service name), <code className="px-1 rounded font-mono text-xs" style={{ backgroundColor: "var(--card)", color: "#4a5535" }}>type</code> (product, service, or subscription), <code className="px-1 rounded font-mono text-xs" style={{ backgroundColor: "var(--card)", color: "#4a5535" }}>base_price</code> & <code className="px-1 rounded font-mono text-xs" style={{ backgroundColor: "var(--card)", color: "#4a5535" }}>currency</code> (standard pricing), <code className="px-1 rounded font-mono text-xs" style={{ backgroundColor: "var(--card)", color: "#4a5535" }}>unit</code> (unit of measure like hour or seat), <code className="px-1 rounded font-mono text-xs" style={{ backgroundColor: "var(--card)", color: "#4a5535" }}>tax_rate</code> (applicable tax percentage), and <code className="px-1 rounded font-mono text-xs" style={{ backgroundColor: "var(--card)", color: "#4a5535" }}>inventory</code> (link to physical stock).</li>
                                        <li><strong>Inventory Fields:</strong> <code className="px-1 rounded font-mono text-xs" style={{ backgroundColor: "var(--card)", color: "#4a5535" }}>sku</code> (unique tracking code), <code className="px-1 rounded font-mono text-xs" style={{ backgroundColor: "var(--card)", color: "#4a5535" }}>quantity_on_hand</code> (current stock), <code className="px-1 rounded font-mono text-xs" style={{ backgroundColor: "var(--card)", color: "#4a5535" }}>reorder_level</code> (threshold for low stock warnings), and <code className="px-1 rounded font-mono text-xs" style={{ backgroundColor: "var(--card)", color: "#4a5535" }}>location</code> (physical location of the item).</li>
                                    </ul>
                                </AccordionContent>
                            </AccordionItem>
                            <AccordionItem value="item-fields-inv">
                                ...
                                <AccordionContent>
                                    <ul className="list-disc list-inside space-y-2 mt-2">
                                        <li><strong>Invoice Fields:</strong> <code className="px-1 rounded font-mono text-xs" style={{ backgroundColor: "var(--card)", color: "#4a5535" }}>client</code> & <code className="px-1 rounded font-mono text-xs" style={{ backgroundColor: "var(--card)", color: "#4a5535" }}>contact</code> (who the invoice is for), <code className="px-1 rounded font-mono text-xs" style={{ backgroundColor: "var(--card)", color: "#4a5535" }}>status</code> (draft, sent, paid, overdue, etc.), <code className="px-1 rounded font-mono text-xs" style={{ backgroundColor: "var(--card)", color: "#4a5535" }}>issue_date</code> & <code className="px-1 rounded font-mono text-xs" style={{ backgroundColor: "var(--card)", color: "#4a5535" }}>due_date</code> (billing timelines), auto-calculated financial summaries like <code className="px-1 rounded font-mono text-xs" style={{ backgroundColor: "var(--card)", color: "#4a5535" }}>subtotal</code>, <code className="px-1 rounded font-mono text-xs" style={{ backgroundColor: "var(--card)", color: "#4a5535" }}>tax_amount</code>, <code className="px-1 rounded font-mono text-xs" style={{ backgroundColor: "var(--card)", color: "#4a5535" }}>discount</code>, & <code className="px-1 rounded font-mono text-xs" style={{ backgroundColor: "var(--card)", color: "#4a5535" }}>total</code>, and <code className="px-1 rounded font-mono text-xs" style={{ backgroundColor: "var(--card)", color: "#4a5535" }}>amount_paid</code> (tracked from payments).</li>
                                        <li><strong>Invoice Line Item Fields:</strong> <code className="px-1 rounded font-mono text-xs" style={{ backgroundColor: "var(--card)", color: "#4a5535" }}>catalogue_item</code> (reference to a predefined catalog item), <code className="px-1 rounded font-mono text-xs" style={{ backgroundColor: "var(--card)", color: "#4a5535" }}>description</code> (specific details of the charge), <code className="px-1 rounded font-mono text-xs" style={{ backgroundColor: "var(--card)", color: "#4a5535" }}>quantity</code> & <code className="px-1 rounded font-mono text-xs" style={{ backgroundColor: "var(--card)", color: "#4a5535" }}>unit_price</code> (used for line subtotal), and <code className="px-1 rounded font-mono text-xs" style={{ backgroundColor: "var(--card)", color: "#4a5535" }}>tax_rate</code> (tax percentage for that specific line).</li>
                                    </ul>
                                </AccordionContent>
                            </AccordionItem>
                        </Accordion>
