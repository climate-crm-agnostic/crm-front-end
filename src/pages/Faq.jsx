            ...
            <div className="max-w-3xl mx-auto space-y-8">
                ...
                <div className="flex items-center justify-between flex-wrap gap-4">
                    <div className="flex items-center gap-3">
                        ...
                        >
                            <HelpCircle className="h-6 w-6" style={{ color: "#1A3A30" }} />
                        </div>
                        <div>
                    ...
                    <CardContent>
                        <Accordion type="single" collapsible className="w-full">
                            ...
                            <AccordionItem value="item-fields-cat">
                                ...
                                <AccordionContent>
                                    <ul className="list-disc list-inside space-y-2 mt-2">
                                        <li><strong>Category Fields:</strong> <code className="px-1 rounded font-mono text-xs" style={{ backgroundColor: "var(--card)", color: "#14302A" }}>name</code> (the category name), <code className="px-1 rounded font-mono text-xs" style={{ backgroundColor: "var(--card)", color: "#14302A" }}>description</code> (details about the category's purpose), and <code className="px-1 rounded font-mono text-xs" style={{ backgroundColor: "var(--card)", color: "#14302A" }}>parent</code> (links to a parent category to create subcategories).</li>
                                        <li><strong>Catalogue Item Fields:</strong> <code className="px-1 rounded font-mono text-xs" style={{ backgroundColor: "var(--card)", color: "#14302A" }}>name</code> (product/service name), <code className="px-1 rounded font-mono text-xs" style={{ backgroundColor: "var(--card)", color: "#14302A" }}>type</code> (product, service, or subscription), <code className="px-1 rounded font-mono text-xs" style={{ backgroundColor: "var(--card)", color: "#14302A" }}>base_price</code> & <code className="px-1 rounded font-mono text-xs" style={{ backgroundColor: "var(--card)", color: "#14302A" }}>currency</code> (standard pricing), <code className="px-1 rounded font-mono text-xs" style={{ backgroundColor: "var(--card)", color: "#14302A" }}>unit</code> (unit of measure like hour or seat), <code className="px-1 rounded font-mono text-xs" style={{ backgroundColor: "var(--card)", color: "#14302A" }}>tax_rate</code> (applicable tax percentage), and <code className="px-1 rounded font-mono text-xs" style={{ backgroundColor: "var(--card)", color: "#14302A" }}>inventory</code> (link to physical stock).</li>
                                        <li><strong>Inventory Fields:</strong> <code className="px-1 rounded font-mono text-xs" style={{ backgroundColor: "var(--card)", color: "#14302A" }}>sku</code> (unique tracking code), <code className="px-1 rounded font-mono text-xs" style={{ backgroundColor: "var(--card)", color: "#14302A" }}>quantity_on_hand</code> (current stock), <code className="px-1 rounded font-mono text-xs" style={{ backgroundColor: "var(--card)", color: "#14302A" }}>reorder_level</code> (threshold for low stock warnings), and <code className="px-1 rounded font-mono text-xs" style={{ backgroundColor: "var(--card)", color: "#14302A" }}>location</code> (physical location of the item).</li>
                                    </ul>
                                </AccordionContent>
                            </AccordionItem>
                            <AccordionItem value="item-fields-inv">
                                ...
                                <AccordionContent>
                                    <ul className="list-disc list-inside space-y-2 mt-2">
                                        <li><strong>Invoice Fields:</strong> <code className="px-1 rounded font-mono text-xs" style={{ backgroundColor: "var(--card)", color: "#14302A" }}>client</code> & <code className="px-1 rounded font-mono text-xs" style={{ backgroundColor: "var(--card)", color: "#14302A" }}>contact</code> (who the invoice is for), <code className="px-1 rounded font-mono text-xs" style={{ backgroundColor: "var(--card)", color: "#14302A" }}>status</code> (draft, sent, paid, overdue, etc.), <code className="px-1 rounded font-mono text-xs" style={{ backgroundColor: "var(--card)", color: "#14302A" }}>issue_date</code> & <code className="px-1 rounded font-mono text-xs" style={{ backgroundColor: "var(--card)", color: "#14302A" }}>due_date</code> (billing timelines), auto-calculated financial summaries like <code className="px-1 rounded font-mono text-xs" style={{ backgroundColor: "var(--card)", color: "#14302A" }}>subtotal</code>, <code className="px-1 rounded font-mono text-xs" style={{ backgroundColor: "var(--card)", color: "#14302A" }}>tax_amount</code>, <code className="px-1 rounded font-mono text-xs" style={{ backgroundColor: "var(--card)", color: "#14302A" }}>discount</code>, & <code className="px-1 rounded font-mono text-xs" style={{ backgroundColor: "var(--card)", color: "#14302A" }}>total</code>, and <code className="px-1 rounded font-mono text-xs" style={{ backgroundColor: "var(--card)", color: "#14302A" }}>amount_paid</code> (tracked from payments).</li>
                                        <li><strong>Invoice Line Item Fields:</strong> <code className="px-1 rounded font-mono text-xs" style={{ backgroundColor: "var(--card)", color: "#14302A" }}>catalogue_item</code> (reference to a predefined catalog item), <code className="px-1 rounded font-mono text-xs" style={{ backgroundColor: "var(--card)", color: "#14302A" }}>description</code> (specific details of the charge), <code className="px-1 rounded font-mono text-xs" style={{ backgroundColor: "var(--card)", color: "#14302A" }}>quantity</code> & <code className="px-1 rounded font-mono text-xs" style={{ backgroundColor: "var(--card)", color: "#14302A" }}>unit_price</code> (used for line subtotal), and <code className="px-1 rounded font-mono text-xs" style={{ backgroundColor: "var(--card)", color: "#14302A" }}>tax_rate</code> (tax percentage for that specific line).</li>
                                    </ul>
                                </AccordionContent>
                            </AccordionItem>
                        </Accordion>
                ...
                <div className="text-center text-sm pt-8" style={{ color: "var(--muted-foreground)", borderTop: "1px solid var(--border)", paddingTop: "2rem" }}>
                    ...
                    <a href="mailto:project@codex.academy" className="underline" style={{ color: "#1A3A30" }}>project@codex.academy</a>
                </div>
