...
export const Contact = () => {
    ...
    const filteredImportClients = importClients.filter(c =>
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
                    <div className="bg-background rounded-xl shadow-2xl w-full max-w-[680px] max-h-[88vh] flex flex-col">
                        ...
                        <div className="flex items-center justify-between px-6 py-4 border-b border-border">
                            <div>
                                <h2 className="text-lg font-bold text-secondary-text">Import Contacts from Excel</h2>
                        ...
                        <div className="px-6 py-5 overflow-y-auto flex-1 space-y-5">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-muted-foreground mb-2">All contacts in the file will be assigned to this client.</p>
                                <input
                                    type="text"
